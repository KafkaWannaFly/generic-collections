...
It is implemented by collection which has index in their structure: [list](list/ "mention"), [linkedlist.md](linkedlist.md "mention"), [stack.md](stack.md "mention"), [queue.md](queue.md "mention")
